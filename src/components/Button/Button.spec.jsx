...
describe('<Button />', () => {
  ...
  it('should render the button with the text "Load More"', () => {
    //Inicia um teste
    const fn = jest.fn();
    render(<Button text="Load More" disabled={false} onClick={fn} />); //Renderiza um elemento
  ...
  it('should disabled when disabled is true', () => {
    //Inicia um teste
    const fn = jest.fn();
    render(<Button text="Load More" disabled={true} onClick={fn} />); //Renderiza um elemento
    const button = screen.getByRole('button', { name: /load more/i }); //Captura um elemento renderizado pelo tipo e texto
