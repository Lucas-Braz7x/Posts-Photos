...
describe('<Button />', () =>{ //Agrupa ps testes
  /* Deveria rendereizar o botão com o texto "Load More" */
  it('should render the button with the text "Load More"', () => {//Inicia um teste
  ...
  it('should call function on button click', () => {//Inicia um teste
  ...
  it('should disabled when disabled is true', () => {//Inicia um teste
